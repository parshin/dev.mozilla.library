...
def index(request):
	return HttpResponse('This is catalog view')
...
def index(request):
	...
	num_fiction_genres = Genre.objects.filter(name__contains='Биография').count()
	num_fiction_books = Book.objects.filter(genre__name__contains='Биография').count()
